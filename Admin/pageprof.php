<!-- Main content -->
        <section class="content" style="background:transparent; margin-bottom:-4%;margin-left:-2.5%;margin-right:-2.5%;margin-top:-2.5%;">
		<div class="box">
		<div class="box-body">
<div class="col-md-12">
              ...
              <div class="table-responsive mailbox-messages">
				...
				<thead>
				 <tr>
				  ...
				  include('connect.php');
				  $doc_id=$_SESSION['id'];
				  $sql=mysql_query("SELECT `p_id` , `name` , `mobile` , `d_id`, `case_id` , `status` FROM `patient` INNER JOIN `case` ON patient.p_id = case.pat_id AND `d_id`='$doc_id' AND `status`='Created'");
