    ...
    <section class="content" style="margin-left:-1%;margin-right:-1%; margin-top:-1%;min-height:575px;">
     ...
     <div class="box">
      <div class="box-header with-border">
          <h3 class="box-title" style="font-weight:600">View Citizen Details</h3>
        </div>
		...
		<form class="form-horizontal" name="frmnews" method="post" action="list_citizen_user.php" enctype="multipart/form-data">
				...
				<thead>
				 <tr>
				  ...
				  <tr>
                    ...
                    <td class="mailbox-subject"><?php print $row['name']; ?></td>
	...
	<script type="text/javascript">
		...
		function delete_temple(cid) {
			if(confirm("You are going to delete this Entry. Are you Sure?")){
				...
				xhttp.open("GET", "delete_citizen.php?cid="+cid, true);
				xhttp.send();
			}
		}
