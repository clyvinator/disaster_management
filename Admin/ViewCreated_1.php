					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4">
									...
									<img src="uploads/Intra-oral/'.$br['anterior_frontal'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Buccal left-side </label>
									<img src="uploads/Intra-oral/'.$br['buccal_leftside'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Buccal right-side </label>
									<img src="uploads/Intra-oral/'.$br['buccal_rightside'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Lower occlusal </label>
									<img src="uploads/Intra-oral/'.$br['lower_occlusal'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Upper occlusal </label>
									<img src="uploads/Intra-oral/'.$br['upper_occlusal'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4">
									...
									<img src="uploads/Intra-oral/'.$br['frontal_profile'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="250">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Frontal Profile-smiling </label>
									<img src="uploads/Intra-oral/'.$br['frontal_simling'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="250">
								</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Side Profile </label>
									<img src="uploads/Intra-oral/'.$br['side_profile'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="250">
										</br>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-4">
								...
								<img src="uploads/Intra-oral/'.$br['lateral_cephalometry'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
									</br>
							</div>
							<div class="col-md-4">
									<label  class="control-label">Panoramin Radiography(OPG) </label>
									<img src="uploads/Intra-oral/'.$br['panoramin_radiography'].'" style="border:2px solid #E3E2DF" class="img-rounded" width="100%" height="200">
								</br>
							</div>
						</div>
					</div>
