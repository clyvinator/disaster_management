<?php 	include("database.php");
		...
		$sql = "select * from rescue where rid=".$rid;
		$rs = mysql_query($sql);
...
<?php include('sidebar.php'); ?>
    ...
    <section class="content">
      ...
      <div>
		...
		<?php	$sql = "select * from rescue where rid=".$rid;
				...
				while($row = mysql_fetch_array($rs)){
		?>
			<form class="form" name="frmnews" method="post" action="edit_rescue.php?rid=<?php print $rid; ?>" enctype="multipart/form-data">
            <div class="panel">
  <div class="panel-body">
             ...
             <div class="form-group">
            	...
            	<div class = "col-sm-10">
            		<input type="text" class="form-control" value="<?php print $row['title']; ?>" style="margin-bottom:10px" disabled>
