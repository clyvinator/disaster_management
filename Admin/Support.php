  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="background:transparent;">
      ...
      <!-- Default box -->
        ...
        <div style="margin-top:10%; margin-left:70%; margin-bottom:-3%;">
          <!-- DIRECT CHAT WARNING -->
          <div class="box box-warning direct-chat direct-chat-warning" id="chat">
			...
			<div>
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg right">
                  <div class="direct-chat-info clearfix">
                    <span class="direct-chat-name pull-right">Doctor Name</span>
